...
/**
 * Data source for the KontoTable view. This class should
...
export class KontoTableDataSource extends DataSource<Konto> {
  ...
  constructor(private paginator: MatPaginator, private sort: MatSort, @Inject(HttpClient) private httpClient: HttpClient) {
    super();
